...
test("should redirect if not logged in", async () => {
  ...
  expect(screen.queryByText("60d82fb65ab70e8b14f7fb79")).toBeInTheDocument()
  expect(screen.queryByText("60d82fdf5ab70e8b14f7fb7c")).toBeInTheDocument()
  expect(screen.queryByText("60d8303d5ab70e8b14f7fb7e")).toBeInTheDocument()
  expect(screen.queryByText("60d8304d5ab70e8b14f7fb80")).toBeInTheDocument()
})
