        ...
        {loading ? (
          ...
          <>
            ...
            <div className='flex justify-evenly place-items-center'>
              ...
              <span md={3} className='h-full justify-evenly'>
                <span className='align-top'>hello</span>
                <ListGroup variant='flush'>
                  <h1
                    className='font-bold uppercase text-2xl mb-10'
                    data-testid='cert-name'
                  >
                    {cert.name}
                  </h1>
                  <ListGroup.Item>
                    <p data-testid='cert-issuer' className='mb-5'>
                      {cert.issuer}
                    </p>
                    <h3 data-testid='cert-name' className='mb-5'>
                      {cert.name}
                    </h3>
                  </ListGroup.Item>
                  <ListGroup.Item>
